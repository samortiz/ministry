...
def drawTitlePage():
  ...
  canvas.drawCentredString(pageWidth/2, yTopOfPage-100 , "Christian Students")
  canvas.drawCentredString(pageWidth/2, yTopOfPage-150, "at U of C")
  canvas.drawCentredString(pageWidth/2, yTopOfPage-250, "Songbook")
